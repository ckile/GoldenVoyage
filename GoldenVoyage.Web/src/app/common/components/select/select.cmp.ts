...
export class GvSelectComponent implements OnInit {
    @Input() public allowClear: boolean = false;
    @Input() public placeholder: string = '';
    @Input() public idField: string = 'value';
...
export class Behavior {
    ...
    public actor: GvSelectComponent;
    public constructor(actor: GvSelectComponent) {
        this.actor = actor;
    }
